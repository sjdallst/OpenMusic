package org.mhacks.openmusic.ui.animators;
...
public class RecyclerViewItemSlideAnimator extends RecyclerView.ItemAnimator {
			...
			for (final RecyclerView.ViewHolder viewHolder : mPendingAdd) {
				...
				animator.playTogether(
						ObjectAnimator.ofFloat(
								target, "translationX", -target.getMeasuredWidth(), 0.0f),
	...
	public boolean isRunning() {
		return !mPendingAdd.isEmpty() ||
				!mPendingRemove.isEmpty();
	}
}
